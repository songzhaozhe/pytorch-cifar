...
trainset = custom_CIFAR100(root='./data', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True, num_workers=5, pin_memory=True)

testset = custom_CIFAR100(root='./data', train=False, download=True, transform=transform_test)
