...
class pro_CIFAR100(torchvision.datasets.CIFAR100):
    def __init__(self, proportion, root, train=True,
                 transform=None, target_transform=None,
                 download=False, perm=None, erase_start=100):
        self.root = os.path.expanduser(root)
        self.transform = transform
        self.ERASE_LABELS = [i for i in range(erase_start, 100)]
    ...
    def __len__(self):
        if self.train:
            ...
            return 10000-len(self.ERASE_LABELS)*100
