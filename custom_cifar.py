...
class custom_CIFAR10(torchvision.datasets.CIFAR10):
    def __init__(self, root, train=True,
        ...
        if self.train:
            ...
            new_train = np.zeros([50000-len(ERASE_LABELS)*5000, 32, 32, 3], dtype=np.uint8) # uint8 is necessary
            new_labels = []
            idx = 0
            ...
            new_test = np.zeros([10000-len(ERASE_LABELS)*1000, 32, 32, 3], dtype=np.uint8) # uint8 is necessary
            new_labels = []
            idx = 0
